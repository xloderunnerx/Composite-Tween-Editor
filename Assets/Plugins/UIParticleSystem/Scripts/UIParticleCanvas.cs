...
public class UIParticleCanvas : MonoBehaviour
{
    ...
    private List<UIParticleDepthObject> depthObjects = new List<UIParticleDepthObject>();
    ...
    public void UnregisterUIParticleDepthObject(UIParticleDepthObject obj)
    {
        depthObjects.Remove(obj);
        SetDirty();
    }

    public void RegisterUIParticleDepthObject(UIParticleDepthObject obj)
    {
    ...
    private int SortDepthObjects(UIParticleDepthObject x, UIParticleDepthObject y)
    {
